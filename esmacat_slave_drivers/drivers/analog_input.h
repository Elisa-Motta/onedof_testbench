...
public:
    ...
    uint32_t esmacat_slave_product_id = ESMACAT_ANALOG_INPUT_PRODUCT_ID;
     /** Contains a unique Vendor ID assigned by the EtherCAT Technology Group*/
    uint32_t esmacat_slave_vendor_id = ESMACAT_ANALOG_INPUT_VENDOR_ID;
