...
void onedof_manager::loop()
{
    ...
    /**
        // Current Control - TODO: This mode needs direct_escon_control to be enabled
    ...
    case 100:
    {
        ...
        for(int j=0;j<N_DOFS;j++){
            ...
            interim_time_exercise = (elapsed_time_ms-elapsed_time_ms_offset);
...
//                    5000.0*cos(agree_joints[2].joint_values.incremental_encoder_reading_radians)*cos(agree_joints[3].joint_values.incremental_encoder_reading_radians), (elapsed_time_ms - elapsed_time_ms_offset));
    ...
    case robot_control_mode_t::go_position_control:
    {
        ...
        for(int joint_index=0;joint_index<N_DOFS;joint_index++)
        {
            ...
            target_torq[joint_index]  = agree_robot.gravity_torques_mNm[joint_index]; //TODO: Check sign with testbed
...
//               << "Gravity:   [mNm]: "   << fixed << setprecision(3)  << agree_robot.gravity_torques_mNm(0)                              << endl
//               << "Weight:    [mNm]: "   << fixed << setprecision(3)  << agree_robot.weight_compensation_torques_mNm(0)                    << endl
...
//                << "Feedforward[mNm]: "   << fixed << setprecision(3)  << agree_joints[0].get_impedance_control_torque_mNm() << " << " << agree_robot.impedance_control_feedforward_torque_mNm(0) *rad_to_deg         << endl
