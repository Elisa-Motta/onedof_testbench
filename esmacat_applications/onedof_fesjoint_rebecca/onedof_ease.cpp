...
onedof_ease::onedof_ease()
{

}

esmacat_err onedof_ease::set_robot_referenced(bool robot_referenced){
    esmacat_err err = NO_ERR;
    err = set_output_variable(6,1);
    return err;
}

bool onedof_ease::is_robot_referenced(){
    // get
...
esmacat_err onedof_ease::set_calibration_ready(bool calibration_ready){
    esmacat_err err = NO_ERR;
    err = set_output_variable(7,1);
    return err;
}

bool onedof_ease::is_calibration_ready(){
...
esmacat_err onedof_ease::set_calibration_reference_counts(int index, int32_t output_calibration_reference_counts){
    esmacat_err err = NO_ERR;
    err = set_output_variable(index,static_cast<int16_t>(output_calibration_reference_counts/conversion_factor));
    return err;
}

int32_t onedof_ease::get_calibration_reference_counts(int index){
...
esmacat_err onedof_ease::set_output_variable(int index, int16_t output_variable){
...
int16_t onedof_ease::get_input_variable(int index){
    // Initialize error to NO_ERR
    esmacat_err err = NO_ERR;
