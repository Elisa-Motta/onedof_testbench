...
struct impedance_control_terms_t
{
    ...
    /** Net torque for arm weight compensation */
    float arm_dynamic_torque_mNm = 0.0;
    /** Net torque for arm weight compensation */
    float robot_dynamic_torque_mNm = 0.0;
    /** Net torque for arm weight compensation */
    float total_dynamic_torque_mNm = 0.0;
    /** Net torque for onedof weight compensation */
    float robot_weight_torque_mNm = 0.0;
...
struct impedance_control_command_t{
    ...
    // *********
    /** Allocation factor for impedance controller */
