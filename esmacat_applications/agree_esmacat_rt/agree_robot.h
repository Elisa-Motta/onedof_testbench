...
public:
    ...
    // Length properties
    double upperarm_length_m;
    double forerarm_length_m;
    ...
    // Length properties
    double link_length[N_DOFS];
    double trunk_height_m;
    double trunk_width_m;
    // Mass Properties
...
//    Eigen::Vector3d cartesian_force;
    ...
    void read_agree_user_parameters(int side);

    Eigen::MatrixXd compute_dh_model(int side);
    int get_joint_sign(int joint_index){return DH_to_motor_sign(joint_index);}
