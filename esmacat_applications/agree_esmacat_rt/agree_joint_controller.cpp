...
//    prev_friction_comp_torque_mNm = friction_comp_torque_mNm;
    ...
    if (loadcell_reading_status == NO_ERR)
    {
        ...
        {
            ethercat_interface.set_escon_enable(true); // FIX: what to do here?
            error = ERR_MEASURED_LOAD_OUTSIDE_RANGE;
    ...
    joint_impedance_control_terms.impedance_control_k_mNm_rad       = controller_config.impedance_control_k_gain_mNm_per_rad;
    joint_impedance_control_terms.impedance_control_d_mNm_rad_per_sec   = controller_config.impedance_control_d_gain_mNm_per_rad_per_sec;
