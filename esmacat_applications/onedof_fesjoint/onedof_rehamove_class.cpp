...
//        cin >> input_char;
        ...
        //cout << "Il carattere è : "<<  input_char << endl;
...
//            break;
        ...
        case 'w': case 'W':
            ...
            input_char=getchar();
            if(input_char=='-'){
                app.coeff_weight_assistance -= 0.01;
...
void onedof_rehamove_class::print_command_keys()
{
  ...
  std::cout << blue_key << "\'4\'" << color_key << ": MOTOR CALIBRATION 1: WEIGHT ASSITANCE mode" << "\n";
  std::cout << blue_key << "\'5\'" << color_key << ": MOTOR CALIBRATION 2: MEAN & STD mode" << "\n";

  std::cout << blue_key << "\'6\'" << color_key << ": PI FES mode"<< "\n";
  std::cout << blue_key << "\'7\'" << color_key << ": ILC ONLY mode"<< "\n";
  std::cout << blue_key << "\'8\'" << color_key << ": POSITION mode"<< "\n";
  std::cout << blue_key << "\'9\'" << color_key << ": ILC + ALLOCATION MODULATION mode"<< "\n";

  std::cout << blue_key << "\'t\'" << color_key << ": Trial mode"<< "\n";
  std::cout << blue_key << "\'f\'" << color_key << ": Flex+Ext mode"<< "\n";



//  std::cout << blue_key << "\'M\'" << color_key << ": 100% MOTOR ALLOCATION mode"<< "\n";
