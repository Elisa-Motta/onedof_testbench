    ...
    while( c.data->stop == 0)
    {
        if(kbhit())
        {
            ...
            case '9': case '6':
                cout << ": Running " << robot_mode_labels[stoi(&input_char)] << " mode!" << endl;
                c.data->control_mode_command = static_cast<robot_control_mode_t>(stoi(&input_char));
                c.data->impedance_control_command->impedance_control_k_gain_mNm_per_rad         = 10.0;
                c.data->impedance_control_command->impedance_control_d_gain_mNm_per_rad_per_sec = 2.0;
                break;


            case 'a': case 'A':
                cout << ": Running Passive + Weight Compensation Actual" << endl;
                c.data->control_mode_command = robot_control_mode_t::impedance_ext_control;
                c.data->impedance_control_command->impedance_control_k_gain_mNm_per_rad         = 40.0;
                c.data->impedance_control_command->impedance_control_d_gain_mNm_per_rad_per_sec = 2.0;
...
//                c.data->arm_weight_compensation_config.weight_assistance = 0.5;
            ...
            case 'd': case 'D':
                cout << ": Running Passive + Weight Compensation Desired" << endl;
            ...
            case 'w': case 'W':
                cout << ": Weight Compensation" << endl;
                c.data->control_mode_command = robot_control_mode_t::impedance_ext_control;
                c.data->impedance_control_command->impedance_control_k_gain_mNm_per_rad         = 0.0;
                c.data->impedance_control_command->impedance_control_d_gain_mNm_per_rad_per_sec = 0.5;
                c.data->arm_weight_compensation_config.human_height_m = 1.70;
                c.data->arm_weight_compensation_config.human_weight_kg = 60;
                c.data->arm_weight_compensation_config.weight_assistance = 0.5;
                break;
            ...
            case '+':
                ...
                cout << ": Weight Compensation Increased" << endl;
                c.data->arm_weight_compensation_config.weight_assistance += 0.05;
                cout << " Weight Assistance" << c.data->arm_weight_compensation_config.weight_assistance << endl;
                break;
            case '-':
                cout << ": Weight Compensation Decreased" << endl;
                c.data->arm_weight_compensation_config.weight_assistance -= 0.1;
                cout << " Weight Assistance" << c.data->arm_weight_compensation_config.weight_assistance << endl;
                break;
...
//  std::cout << blue_key << "\'5\'" << color_key << ": FREEZE mode"<< "\n";
  std::cout << blue_key << "\'8\'" << color_key << ": HOMING mode"<< "\n";
  std::cout << blue_key << "\'9\'" << color_key << ": POSITION mode"<< "\n";
