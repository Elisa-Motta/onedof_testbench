...
class onedof_shared_memory_comm
{
    struct shared_memory_packet {
        ...
        // Rehamove control values
        int rehamove_mode = 1;
        double rehamove_charge = 0.0;
        int rehamove_iteration = 0;
        double rehamove_mean_position_error = 0.0;
        double rehamove_mean_velocity =0.0;
        double rehamove_charge_adj = 0.0;
        double rehamove_std_mean_position_error = 0.0;
        double rehamove_mean_mean_position_error = 0.0;
        double rehamove_mean_std_mean_position_error = 0.0;
        double rehamove_threshold_mean_mean_position_error = 0.0;
        double rehamove_threshold_mean_std_mean_position_error = 0.0;
        double rehamove_desired_position_pid = 0.0;
        double rehamove_final_reaching_error = 0.0;
        double rehamove_delta_alloc = 0.0;
        int rehamove_num_block=0;
        double rehamove_mean_vel_block = 0.0;
        double rehamove_std_vel_block = 0.0;
        double rehamove_m = 0.0;
        double rehamove_up =0.0;
        double rehamove_down = 0.0;
        int rehamove_k_fatigue = 0;
        int rehamove_counter_no_change = 0;
        int rehamove_counter_q_adj = 0;
        double rehamove_mean_alloc_tor =0.0;

        double arm_feedforward_torq = 0.0;
