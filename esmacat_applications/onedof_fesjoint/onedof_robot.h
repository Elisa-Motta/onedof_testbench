...
public:
    ...
    Eigen::VectorXd robot_weight_torque_mNm;
    Eigen::VectorXd arm_weight_torque_mNm;
    Eigen::VectorXd total_weight_torque_mNm;
    ...
    Eigen::VectorXd robot_dynamic_torque_mNm;
    Eigen::VectorXd total_dynamic_torque_mNm;
    Eigen::VectorXd arm_dynamic_torque_mNm;
    ...
    /** Torques required at each joint frame to follow trajectory of robot+human*/
    Eigen::VectorXd inverse_dynamics_torques_mNm;
    ...
    float impedance_control_feedforward_allocation_factor;

//    /** Joint acceleration */
//    Eigen::VectorXd impedance_control_acc;
    ...
    double          get_inverse_dynamics_torque_onedof(float a, double position, double acceleration);
